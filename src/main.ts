...
import { type IMedicalSupplies } from './types/generated/IMedicalSupplies';
...
export interface ICmsDataToolsOptions {
  enableLocalCache: boolean;
  baseURL: string;
  cacheDirectory: string;
}

export const defaultCmsDatToolsOptions: ICmsDataToolsOptions = {
...
export class CmsDataTools {
  private options: ICmsDataToolsOptions;
  private axiosClient: AxiosInstance;

  constructor(options: Partial<ICmsDataToolsOptions>) {
    this.options = { ...defaultCmsDatToolsOptions, ...options };
  ...
  public async retrieveData<T>(
    ...
    const fnOptions = { ...this.options, ...options };
    if (!fnOptions.enableLocalCache) {
      console.info('cache disabled', { slug });
